                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="contact__btn">
                                                <!-- <a href="#">Send</a> -->
                                                <button type="button" onclick="_notification()" class="btn btn-primary">Send</button>
                                            </div>
                                        </div>
                                    </div>
                                </sf:form>
