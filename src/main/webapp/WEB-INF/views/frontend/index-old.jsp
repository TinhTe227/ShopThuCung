					...
					<div class="main__products-content">
						<div class="row">
							<div class="col-12 col-lg-3 col-md-6">
								<div class="product">
									<div class="thumb">
										<a href="./sanpham.html" class="image"> <img
											src=".${classpath}/frontend/img/products/1.jpg" class="fit-img zoom-img">
							...
							<div class="col-12 col-lg-3 col-md-6">
								<div class="product">
									<div class="thumb">
										<a href="./sanpham.html" class="image"> <img
											src=".${classpath}/frontend/img/products/4.jpg" class="fit-img zoom-img">
							...
							<div class="col-12 col-lg-3 col-md-6">
								<div class="product">
									<div class="thumb">
										<a href="./sanpham.html" class="image"> <img
											src=".${classpath}/frontend/img/products/2.jpeg" class="fit-img zoom-img">
										</a> <span class="badges"> <!-- <span class="sale">-20%</span> -->
										</span>
									</div>
									<div class="content">
							...
							<div class="col-12 col-lg-3 col-md-6">
								<div class="product">
									<div class="thumb">
										<a href="./sanpham.html" class="image"> <img
											src=".${classpath}/frontend/img/products/7.jpg" class="fit-img zoom-img">
										</a> <span class="badges"> <span class="sale">-20%</span>
										</span>
									</div>
									<div class="content">
					...
					<div class="row">
						<div class="col-12 col-lg-6">
							<a href="./danhmuc.html" class="banner-sale"> <img
								src=".${classpath}/frontend/img/oder-1.jpg" alt="">
							</a>
						</div>
						<div class="col-12 col-lg-6 block none">
							<a href="./danhmuc.html" class="banner-sale"> <img
								src=".${classpath}/frontend/img/oder-2.jpg" alt="">
							</a>
						</div>
					</div>
				</div>
						...
						<div class="row">
							...
							<div class="col-12 col-lg-3 col-md-6">
								<div class="product">
									<div class="thumb">
										<a href="./sanpham.html" class="image"> <img
											src=".${classpath}/frontend/img/products/1.jpeg" class="fit-img zoom-img">
										</a> <span class="badges"> <span class="sale">-15%</span>
										</span>
									</div>
									<div class="content">
										<a href="./sanpham.html" class="content-link">
							...
							<div class="col-12 col-lg-3 col-md-6">
								<div class="product">
									<div class="thumb">
										<a href="./sanpham.html" class="image"> <img
											src=".${classpath}/frontend/img/products/8.jpg" class="fit-img zoom-img">
										</a> <span class="badges"> <span class="sale">-20%</span>
										</span>
									</div>
									<div class="content">
							...
							<div class="col-12 col-lg-3 col-md-6">
								<div class="product">
									<div class="thumb">
										<a href="./sanpham.html" class="image"> <img
											src=".${classpath}/frontend/img/products/7.jpeg" class="fit-img zoom-img">
										</a> <span class="badges"> <span class="sale">-20%</span>
										</span>
									</div>
									<div class="content">
							...
							<div class="col-12 col-lg-3 col-md-6">
								<div class="product">
									<div class="thumb">
										<a href="./sanpham.html" class="image"> <img
											src=".${classpath}/frontend/img/products/5.jpg" class="fit-img zoom-img">
										</a> <span class="badges"> <span class="sale">-20%</span>
										</span>
									</div>
									<div class="content">
							...
							<div class="col-12 col-lg-3 col-md-6">
								<div class="product">
									<div class="thumb">
										<a href="./sanpham.html" class="image"> <img
											src=".${classpath}/frontend/img/products/6.jpeg" class="fit-img zoom-img">
										</a> <span class="badges"> <span class="sale">-20%</span>
										</span>
									</div>
									<div class="content">
							...
							<div class="col-12 col-lg-3 col-md-6">
								<div class="product">
									<div class="thumb">
										<a href="./sanpham.html" class="image"> <img
											src=".${classpath}/frontend/img/products/4.jpeg" class="fit-img zoom-img">
										</a> <span class="badges"> <!-- <span class="sale">-20%</span> -->
											<span class="new">new</span>
						...
						<div class="row">
							<div class="col-12 col-lg-3 col-md-6">
								<div class="product">
									<div class="thumb">
										<a href="./sanpham.html" class="image"> <img
											src=".${classpath}/frontend/img/products/phukien/1.jpg" class="fit-img zoom-img">
										</a>
										<!-- <span class="badges">
							...
							<div class="col-12 col-lg-3 col-md-6">
								<div class="product">
									<div class="thumb">
										<a href="./sanpham.html" class="image"> <img
											src=".${classpath}/frontend/img/products/phukien/4.jpg" class="fit-img zoom-img">
										</a> <span class="badges"> <span class="new">new</span>
										</span>
									</div>
									<div class="content">
					...
					<div class="row">
						...
						<div class="col-12 col-lg-4 col-md-6">
							<div class="product">
								<div class="thumb">
									<a href="./sanpham.html" class="image"> <img
										src=".${classpath}/frontend/img/products/1.jpeg" class="fit-img opacity-img">
									</a>
								</div>
								<div class="content">
						...
						<div class="col-12 col-lg-4 col-md-6">
							<div class="product">
								<div class="thumb">
									<a href="./sanpham.html" class="image"> <img
										src=".${classpath}/frontend/img/products/2.jpg" class="fit-img opacity-img">
									</a>
								</div>
								<div class="content">
									<div class="new__author">
						...
						<div class="col-12 col-lg-4 col-md-6">
							<div class="product">
								<div class="thumb">
									<a href="./sanpham.html" class="image"> <img
										src=".${classpath}/frontend/img/products/6.jpeg" class="fit-img opacity-img">
									</a>
								</div>
								<div class="content">
									<div class="new__author">
				...
				<div class="mobile__content">
					...
					<div class="mobile__navigation">
						<ul class="mobile__nav">
							<li class="mobile__children"><a href="./index.html"
